...
const badReplacement = `
        ...
        return {
`;
js = js.replace(badReplacement, "return {");
...
// we want to put it right before "screenerStatus: \"Offline\","
const target = "screenerStatus: \"Offline\",";
if(js.includes(target)) {
    js = js.replace(target, goodReplacement.replace("return {", "") + "screenerStatus: \"Offline\",");
}

fs.writeFileSync('scraper.js', js);
console.log("Fixed scraper.js quarters fallback");
