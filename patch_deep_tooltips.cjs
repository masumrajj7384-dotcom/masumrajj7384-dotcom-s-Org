...
const fileContent = `const deepTooltips = ${JSON.stringify(deepTooltips, null, 2)};\n`;
fs.writeFileSync('app/static/deep_tooltips.js', fileContent);
console.log("Exhaustive tooltips successfully injected!");
